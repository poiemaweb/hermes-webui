...
const LOCALES = {
  ...
  ko: {
    ...
    mic_error: '음성 입력 오류: ',
    session_imported: '세션 가져옴',
    import_failed: '가져오기 실패: ',
    import_invalid_json: 'JSON 형식이 잘못되었습니다',
    image_pasted: '이미지 붙여넣기: ',
    // messages.js
    edit_message: '메시지 수정',
    regenerate: '응답 다시 생성',
    copy: '복사',
    ...
    collapse_all: '모두 접기',
    edit_failed: '수정 실패: ',
    regen_failed: '다시 생성 실패: ',
    reconnect_active: '응답을 생성 중입니다. 준비되면 새로고침하시겠습니까?',
    reconnect_finished: '이전에 응답 생성이 진행 중이었습니다. 메시지가 업데이트되었을 수 있습니다.',
    // approval card
    approval_heading: '승인 필요',
    approval_desc_prefix: '위험한 명령이 감지되었습니다',
    approval_btn_once: '한 번 허용',
    approval_btn_once_title: '이 명령만 허용 (Enter)',
    approval_btn_session: '세션 동안 허용',
    approval_btn_session_title: '이 대화 세션 동안 허용',
    approval_btn_always: '항상 허용',
    approval_btn_always_title: '이 명령 패턴 항상 허용',
    approval_btn_deny: '거부',
    approval_btn_deny_title: '거부 — 이 명령을 실행하지 않음',
    approval_responding: '응답 중...',
    clarify_heading: '추가 설명 필요',
    clarify_hint: '선택지를 선택하거나 아래에 직접 답변을 입력하세요.',
    clarify_other: '기타',
    clarify_send: '전송',
    clarify_input_placeholder: '답변을 입력하세요...',
    clarify_responding: '응답 중...',
    untitled: '제목 없음',
    n_messages: (n) => `메시지 ${n}개`,
    model_unavailable: ' (사용 불가)',
    model_unavailable_title: '이 모델은 현재 제공자 목록에 없습니다',
    provider_mismatch_warning: (m,p)=>`"${m}"이(가) 설정된 제공자(${p})와 작동하지 않을 수 있습니다. 그대로 본 볼까요? 아니면 터미널에서 'hermes model'을 실행하여 전환하세요.`,
    provider_mismatch_label: '제공자 불일치',
    model_custom_label: '사용자 정의 모델 ID',
    model_custom_placeholder: '예: openai/gpt-5.4',
    // commands.js
    cmd_help: '사용 가능한 명령어 목록',
    cmd_clear: '대화 메시지 지우기',
    cmd_compact: '대화 컨텍스트 압축',
    cmd_model: '모델 전환 (예: /model gpt-4o)',
    cmd_workspace: '이름으로 작업 공간 전환',
    cmd_new: '새 채팅 세션 시작',
    cmd_usage: '토큰 사용량 표시 켜기/끄기',
    cmd_theme: '테마 전환 (system/dark/light/slate/solarized/monokai/nord/oled)',
    cmd_personality: '에이전트 성격 전환',
    cmd_skills: '사용 가능한 Hermes 스킬 목록',
    available_commands: '사용 가능한 명령어:',
    type_slash: '/를 입력하여 명령어 보기',
    conversation_cleared: '대화가 지워졌습니다',
    model_usage: '사용법: /model <name>',
    no_model_match: '"와(과) 일치하는 모델이 없습니다',
    switched_to: '전환됨: ',
    workspace_usage: '사용법: /workspace <name>',
    no_workspace_match: '"와(과) 일치하는 작업 공간이 없습니다',
    switched_workspace: '작업 공간으로 전환됨: ',
    workspace_switch_failed: '작업 공간 전환 실패: ',
    new_session: '새 세션이 생성되었습니다',
    compressing: '컨텍스트 압축 요청 중...',
    token_usage_on: '토큰 사용량 표시 켜짐',
    token_usage_off: '토큰 사용량 표시 꺼짐',
    theme_usage: '사용법: /theme ',
    theme_set: '테마: ',
    no_active_session: '활성 세션이 없습니다',
    no_personalities: '성격 설정을 찾을 수 없습니다 (~/.hermes/personalities/에 추가하세요)',
    available_personalities: '사용 가능한 성격:',
    personality_switch_hint: '\n\n|`/personality <name>`으로 전환하거나 `/personality none`으로 초기화하세요.',
    personalities_load_failed: '성격 설정을 불러오는 데 실패했습니다',
    personality_cleared: '성격 설정이 초기화되었습니다',
    personality_set: '성격: ',
    failed_colon: '실패: ',
    // ui.js
    no_workspace: '작업 공간 없음',
    dialog_confirm_title: '작업 확인',
    dialog_prompt_title: '값 입력',
    dialog_confirm_btn: '확인',
    // workspace.js
    unsaved_confirm: '미리보기에 저장되지 않은 변경사항이 있습니다. 변경사항을 버리고 이동하시겠습니까?',
    discard: '버리기',
    save: '저장',
    edit: '편집',
    clear: '지우기',
    ...
    double_click_rename: '두 번 클릭하여 이름 변경',
    renamed_to: '이름이 변경됨: ',
    ...
    deleted: '삭제됨 ',
    delete_failed: '삭제 실패: ',
    new_file_prompt: '새 파일 이름 (예: notes.md):',
    project_name_prompt: '프로젝트 이름:',
    created: '생성됨 ',
    create_failed: '생성 실패: ',
    new_folder_prompt: '새 폴터 이름:',
    folder_created: '폴터가 생성됨 ',
    folder_create_failed: '폴터 생성 실패: ',
    remove_title: '제거',
    empty_dir: '(비어 있음)',
    upload_failed: '업로드 실패: ',
    all_uploads_failed: (n) => `${n}개 업로드 모두 실패`,
    // settings panel
    settings_title: '설정',
    ...
    settings_label_bubble_layout: '채팅 버블 레이아웃',
    settings_label_cli_sessions: '에이전트 세션 표시',
    settings_label_sync_insights: '인사이트에 동기화',
    settings_label_check_updates: '업데이트 확인',
    settings_label_bot_name: '어시스턴트 이름',
    settings_label_password: '접근 비밀번호',
    settings_saved: '설정이 저장되었습니다',
    settings_save_failed: '저장 실패: ',
    settings_load_failed: '설정을 불러오는 데 실패했습니다: ',
    settings_saved_pw: '설정이 저장되었습니다 — 비밀번호 보호가 활성화되었으며 이 브라우저는 로그인 상태를 유지합니다',
    ...
    login_btn: '로그인',
    login_invalid_pw: '비밀번호가 잘못되었습니다',
    ...
    filter_conversations: '대화 필터링...',
    session_time_unknown: '알 수 없음',
    session_time_just_now: '방금',
    session_time_minutes_ago: (n) => `${n}분 전`,
    session_time_hours_ago: (n) => `${n}시간 전`,
    session_time_days_ago: (n) => `${n}일 전`,
    session_time_last_week: '지난주',
    session_time_bucket_today: '오늘',
    session_time_bucket_yesterday: '어제',
    session_time_bucket_this_week: '이번 주',
    session_time_bucket_last_week: '지난주',
    session_time_bucket_older: '오래됨',
    ...
    workspace_desc: '세션을 위한 작업 공간을 추가하고 전환하세요.',
    new_profile: '새 프로필',
    transcript: '대화 기록',
    download_transcript: 'Markdown으로 다운로드',
    import: '가져오기',
    // Settings detail
    settings_label_sound: '알림 소리',
    settings_desc_sound: '어시스턴트가 응답을 완료하면 소리를 재생합니다.',
    settings_label_notifications: '브라우저 알림',
    settings_desc_notifications: '탭이 백그라운드에 있을 때 응답이 완료되면 시스템 알림을 표시합니다.',
    settings_desc_token_usage: '어시스턴트 응답 아래에 입력/출력 토큰 수를 표시합니다. /usage로도 전환할 수 있습니다.',
    settings_desc_bubble_layout: '사용자 메시지는 오른쪽 정렬, 어시스턴트 응답은 왼쪽 정렬합니다. 코드 블록과 도구 출력을 전체 너비로 유지하려면 기본적으로 꺼져 있습니다.',
    settings_desc_cli_sessions: 'Hermes CLI의 세션(state.db)을 세션 목록에 병합합니다. CLI 세션을 클릭하여 가져오고 대화를 계속하세요.',
    settings_desc_sync_insights: 'WebUI 토큰 사용량을 state.db에 동기화하여 hermes /insights에 브라우저 세션 데이터가 포함되도록 합니다. 기본적으로 꺼져 있습니다.',
    settings_desc_check_updates: 'WebUI 또는 에이전트의 새 버전이 있을 때 배너를 표시합니다. 주기적으로 백그라운드 git fetch를 실행합니다.',
    settings_desc_bot_name: 'UI 전체에서 어시스턴트의 표시 이름입니다. 기본값은 Hermes입니다.',
    settings_desc_password: '새 비밀번호를 설정하거나 변경하려면 입력하세요. 현재 설정을 유지하려면 비워두세요.',
    ...
    empty_subtitle: '무엇이든 물어보세요. 명령을 실행하거나, 파일을 탐색하거나, 예약된 작업을 관리하세요.',
    suggest_files: '이 작업 공간에 어떤 파일이 있나요?',
    suggest_schedule: '오늘 일정이 어떻게 되나요?',
    suggest_plan: '작은 프로젝트를 계획하는 데 도움을 주세요.',
    // onboarding
    onboarding_badge: '첫 실행',
    onboarding_title: 'Hermes Web UI에 오신 것을 환영합니다',
    onboarding_lead: '간단한 설정 가이드가 Hermes를 확인하고, 실제 제공자 구성을 저장하며, 작업 공간과 모델을 선택하고, 선택적으로 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',
    onboarding_continue: '계속',
    onboarding_skip: '설정 건트뛰기',
    onboarding_skipped: '설정이 건트뛰어졌습니다 — 기존 구성을 사용합니다.',
    onboarding_open: 'Hermes 열기',
    onboarding_step_system_title: '시스템 확인',
    onboarding_step_system_desc: 'Hermes 에이전트 및 구성 가시성 확인',
    onboarding_step_setup_title: '제공자 설정',
    onboarding_step_setup_desc: '최소 Hermes 제공자 구성 저장',
    onboarding_step_workspace_title: '작업 공간 + 모델',
    onboarding_step_workspace_desc: '새 세션 및 채팅의 기본값 선택',
    onboarding_step_password_title: '선택적 비밀번호',
    onboarding_step_password_desc: '공유하기 전에 Web UI 보호',
    onboarding_step_finish_title: '완료',
    onboarding_step_finish_desc: '검토하고 앱에 들어가기',
    onboarding_notice_system_ready: 'Hermes 에이전트가 Web UI에서 접근 가능해 보입니다.',
    onboarding_notice_system_unavailable: 'Hermes 에이전트가 아직 완전히 사용 가능하지 않습니다. Bootstrap이 설치할 수 있지만, 제공자 설정은 여전히 터미널이 필요할 수 있습니다.',
    onboarding_check_agent: 'Hermes 에이전트',
    onboarding_check_agent_ready: '감지되고 가져올 수 있음',
    onboarding_check_agent_missing: '누락되었거나 부분적으로 가져올 수 있음',
    onboarding_check_password: '비밀번호',
    onboarding_check_password_enabled: '이미 활성화됨',
    onboarding_check_password_disabled: '아직 활성화되지 않음',
    onboarding_check_provider: '제공자 구성',
    onboarding_check_provider_ready: '채팅 준비 완료',
    onboarding_check_provider_partial: '저장되었지만 불완전함',
    onboarding_check_provider_pending: '확인 필요',
    onboarding_config_file: '구성 파일:',
    onboarding_env_file: '.env 파일:',
    onboarding_unknown: '알 수 없음',
    onboarding_current_provider: '현재 설정:',
    onboarding_missing_imports: '누락된 가져오기:',
    onboarding_notice_setup_required: '여기에서 간단한 제공자 경로를 선택하세요. 고급 OAuth 흐름은 현재 Hermes CLI에 속합니다.',
    onboarding_notice_setup_already_ready: '작동하는 Hermes 제공자 설정이 이미 감지되었습니다. 유지하거나 여기에서 교체할 수 있습니다.',
    onboarding_oauth_provider_ready_title: '제공자가 이미 인증됨',
    onboarding_oauth_provider_ready_body: '이 인스턴스는 Hermes CLI를 통해 설정된 OAuth 제공자(<strong>{provider}</strong>)를 사용하도록 구성되었습니다. 여기서는 API 키가 필요하지 않습니다 — 계속을 클릭하여 설정을 완료하세요.',
    onboarding_oauth_provider_not_ready_title: 'OAuth 제공자가 아직 인증되지 않음',
    onboarding_oauth_provider_not_ready_body: '이 인스턴스는 API 키 대신 OAuth를 사용하는 <strong>{provider}</strong>를 사용하도록 구성되었습니다. 터미널에서 <code>hermes auth</code> 또는 <code>hermes model</code>을 실행하여 인증한 후 Web UI를 새로고침하세요.',
    onboarding_oauth_switch_hint: '또는 아래에서 다른 제공자를 선택하여 API 키 설정으로 전환하세요:',
    onboarding_notice_workspace: '이 값은 일반 앱과 동일한 설정 API를 재사용합니다.',
    onboarding_workspace_label: '작업 공간',
    onboarding_workspace_or_path: '또는 작업 공간 경로 입력',
    onboarding_workspace_placeholder: '/home/you/workspace',
    onboarding_provider_label: '설정 모드',
    onboarding_quick_setup_badge: '빠른 설정',
    onboarding_api_key_label: 'API 키',
    onboarding_api_key_placeholder: '기존 저장된 키를 유지하려면 비워두세요',
    onboarding_api_key_help_prefix: 'Hermes .env 파일에 비밀로 저장됩니다',
    onboarding_base_url_label: '기본 URL',
    onboarding_base_url_placeholder: 'https://your-endpoint.example/v1',
    onboarding_base_url_help: 'OpenAI 호환 라우터, 자체 호스팅 서버, LiteLLM, Ollama, LM Studio, vLLM 또는 유사한 엔드포인트에 사용하세요.',
    onboarding_model_label: '기본 모델',
    onboarding_workspace_help: '설정 완료 후 Hermes가 새 채팅에 사용할 모델을 선택하세요.',
    onboarding_custom_model_placeholder: 'your-model-name',
    onboarding_custom_model_help: '사용자 정의 엔드포인트의 경우 서버가 예상하는 정확한 모델 ID를 입력하세요.',
    onboarding_notice_password_enabled: '비밀번호가 이미 구성되어 있습니다. 교체하려는 경우에만 새 비밀번호를 입력하세요.',
    onboarding_notice_password_recommended: '선택사항이지만 localhost 이외에 노출하려는 경우 권장됩니다.',
    onboarding_password_label: '비밀번호 (선택)',
    onboarding_password_placeholder: '건트뛰려면 비워두세요',
    onboarding_password_help: '비밀번호는 기존 설정 API를 통해 저장되고 서버 측에서 해시됩니다.',
    onboarding_notice_finish: '나중에 설정을 다시 열어 이 중 어느 것이든 변경할 수 있습니다.',
    onboarding_not_set: '설정되지 않음',
    onboarding_password_will_enable: '활성화될 예정',
    onboarding_password_will_replace: '교첼 예정',
    onboarding_password_keep_existing: '현재 비밀번호 유지',
    onboarding_password_remains_disabled: '비활성화 상태 유지',
    onboarding_password_skipped: '일단 건트뜀',
    onboarding_finish_help: '완료하면 설정에 <code>onboarding_completed</code>가 저장되고 일반 앱으로 들어갑니다.',
    onboarding_error_choose_workspace: '계속하기 전에 작업 공간을 선택하세요.',
    onboarding_error_choose_model: '계속하기 전에 모델을 선택하세요.',
    onboarding_error_provider_required: '계속하기 전에 설정 모드를 선택하세요.',
    onboarding_error_base_url_required: '사용자 정의 엔드포인트에는 기본 URL이 필요합니다.',
    onboarding_error_workspace_required: '작업 공간이 필요합니다.',
    onboarding_error_model_required: '모델이 필요합니다.',
    onboarding_complete: '온병 완료',
    // panel/runtime i18n
    error_prefix: '오류: ',
    not_available: '해당 없음',
    never: '없음',
    ...
    dismiss: '무시',
    disable: '비활성화',
    cron_no_jobs: '예약된 작업이 없습니다.',
    cron_status_off: '꺼짐',
    cron_status_paused: '일시 중지',
    cron_status_error: '오류',
    cron_status_active: '활성',
    cron_next: '다음',
    cron_last: '마지막',
    cron_run_now: '지금 실행',
    cron_pause: '일시 중지',
    cron_resume: '재개',
    cron_job_name_placeholder: '작업 이름',
    cron_schedule_placeholder: '일정',
    cron_prompt_placeholder: '프롬프트',
    cron_last_output: '마지막 출력',
    cron_all_runs: '모든 실행',
    cron_hide_runs: '실행 숨기기',
    cron_no_runs_yet: '(아직 실행 없음)',
    cron_schedule_required_example: '일정이 필요합니다 (예: "0 9 * * *" 또는 "every 1h")',
    cron_schedule_required: '일정이 필요합니다',
    cron_prompt_required: '프롬프트가 필요합니다',
    cron_job_created: '작업이 생성되었습니다',
    cron_job_triggered: '작업이 트리거되었습니다',
    cron_job_paused: '작업이 일시 중지되었습니다',
    cron_job_resumed: '작업이 재개되었습니다',
    cron_job_updated: '작업이 업데이트되었습니다',
    cron_delete_confirm_title: '예약 작업 삭제',
    cron_delete_confirm_message: '이 작업은 취소할 수 없습니다.',
    cron_job_deleted: '작업이 삭제되었습니다',
    cron_completion_status: (name, status) => `"${name}" 작업이 ${status}`,
    status_failed: '실패함',
    status_completed: '완료됨',
    todos_no_active: '이 세션에 활성 작업 목록이 없습니다.',
    clear_conversation_title: '대화 지우기',
    clear_conversation_message: '모든 메시지를 지우시겠습니까? 이 작업은 취소할 수 없습니다.',
    clear_failed: '지우기 실패: ',
    skills_no_match: '일치하는 스킬이 없습니다.',
    linked_files: '연결된 파일',
    skill_load_failed: '스킬을 불러올 수 없습니다: ',
    skill_file_load_failed: '파일을 불러올 수 없습니다: ',
    skill_name_required: '스킬 이름이 필요합니다',
    skill_updated: '스킬이 업데이트되었습니다',
    skill_created: '스킬이 생성되었습니다',
    memory_notes_label: '메모리 (메모)',
    memory_saved: '메모리가 저장되었습니다',
    my_notes: '내 메모',
    user_profile: '사용자 프로필',
    no_notes_yet: '아직 메모가 없습니다.',
    no_profile_yet: '아직 프로필이 없습니다.',
    workspace_choose_path: '작업 공간 경로 선택',
    workspace_choose_path_meta: '확인된 경로를 추가하고 이 대화 전환',
    workspace_manage: '작업 공간 관리',
    workspace_manage_meta: '공간 패널 열기',
    workspace_use_title: '현재 세션에서 사용',
    workspace_use: '사용',
    workspace_add_path_placeholder: '작업 공간 경로 추가 (예: /home/user/my-project)',
    workspace_paths_validated_hint: '저장 전에 경로가 기존 디렉토리인지 확인됩니다.',
    workspace_added: '작업 공간이 추가되었습니다',
    workspace_remove_confirm_title: '작업 공간 제거',
    workspace_remove_confirm_message: (path) => `"${path}"을(를) 제거하시겠습니까?`,
    workspace_removed: '작업 공간이 제거되었습니다',
    workspace_switch_prompt_title: '작업 공간 전환',
    workspace_switch_prompt_message: '추가하고 이 대화로 전환할 절대 작업 공간 경로를 입력하세요.',
    workspace_switch_prompt_confirm: '전환',
    workspace_switch_prompt_placeholder: '/Users/you/project',
    workspace_not_added: '작업 공간이 추가되지 않았습니다',
    workspace_already_saved: '작업 공간이 이미 저장됨 — 목록에서 선택하세요',
    workspace_busy_switch: '에이전트가 실행 중일 때는 작업 공간을 전환할 수 없습니다',
    discard_file_edits_title: '파일 편집을 버리시겠습니까?',
    discard_file_edits_message: '작업 공간을 전환하면 미리보기에서 저장되지 않은 파일 편집이 버려집니다.',
    workspace_switched_to: (name) => `${name}(으)로 전환되었습니다`,
    profiles_no_profiles: '프로필을 찾을 수 없습니다.',
    profile_api_keys_configured: 'API 키가 구성됨',
    profile_gateway_running: '게이트웨이 실행 중',
    profile_gateway_stopped: '게이트웨이 중지됨',
    profile_active: '활성',
    profile_no_configuration: '구성 없음',
    profile_skill_count: (count) => `스킬 ${count}개`,
    profile_use: '사용',
    profile_switch_title: '이 프로필로 전환',
    profile_delete_title: '이 프로필 삭제',
    manage_profiles: '프로필 관리',
    profiles_load_failed: '프로필을 불러오는 데 실패했습니다',
    profiles_busy_switch: '에이전트가 실행 중일 때는 프로필을 전환할 수 없습니다',
    profile_switched_new_conversation: (name) => `프로필 전환됨: ${name} — 새 대화가 시작되었습니다`,
    profile_switched: (name) => `프로필 전환됨: ${name}`,
    profile_name_rule: '소문자, 숫자, 하이픈, 밑줄만 사용 가능',
    profile_base_url_rule: '기본 URL은 http:// 또는 https://로 시작해야 합니다',
    profile_created: (name) => `프로필이 생성되었습니다: ${name}`,
    profile_delete_confirm_title: (name) => `프로필 "${name}"을(를) 삭제하시겠습니까?`,
    profile_delete_confirm_message: '이 프로필의 모든 구성, 스킬, 메모리 및 세션이 제거됩니다.',
    profile_deleted: (name) => `프로필이 삭제되었습니다: ${name}`,
    active_conversation_none: '활성 대화가 선택되지 않았습니다.',
    active_conversation_meta: (title, count) => `${title} · 메시지 ${count}개`,
    settings_unsaved_changes: '저장되지 않은 변경사항이 있습니다.',
    sign_out_failed: '로그아웃 실패: ',
    disable_auth_confirm_title: '비밀번호 보호 비활성화',
    disable_auth_confirm_message: '누구나 이 인스턴스에 접근할 수 있게 됩니다.',
    auth_disabled: '인증이 비활성화됨 — 비밀번호 보호가 제거되었습니다',
    disable_auth_failed: '인증 비활성화 실패: ',
    bg_error_single: (title) => `"${title}"에 오류가 발생했습니다`,
    bg_error_multi: (count) => `${count}개 세션에 오류가 발생했습니다`,
  },
};
